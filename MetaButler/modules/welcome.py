...
from MetaButler.modules.helper_funcs.string_handling import (
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Wew! A SUDO USER just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Wew! A Support User just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Thanks for adding me! Join @MetaButler for support.",
                    reply_to_message_id=reply,
                )
                continue
